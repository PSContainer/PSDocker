...
pip install executing==0.8.3 filelock==3.6.0 freetype-py==2.2.0 frozenlist==1.3.0 fsspec==2022.2.0 future==0.18.2 gitdb==4.0.9
ppip install google-auth==2.6.2 google-auth-oauthlib==0.4.6 grpcio==1.44.0 huggingface-hub==0.4.0 hydra-colorlog==1.2.0 hydra-core==1.3.2 idna==3.3 imageio==2.16.1 imageio-ffmpeg==0.4.5 importlib-metadata==4.11.3

pip install ipdb==0.13.9 ipython==8.1.1 jedi==0.18.1 Jinja2==3.1.2 joblib==1.1.0 langcodes==3.3.0 lightning-utilities==0.8.0 lit==16.0.0 loguru==0.6.0 Markdown==3.3.6
...
pip install shortuuid==1.0.8 six==1.16.0 smart-open==6.3.0 smmap==5.0.0 smplx==0.1.28 spacy==3.5.1 spacy-legacy==3.0.12 spacy-loggers==1.0.4 srsly==2.4.6 stack-data==0.2.0

pip install sympy==1.11.1 tensorboard==2.10.0 tensorboard-data-server==0.6.1 tensorboard-plugin-wit==1.8.1 termcolor==1.1.0 thinc==8.1.9 tokenizers==0.11.6 toml==0.10.2 tqdm==4.63.0 traitlets==5.1.1 transformers==4.17.0 trimesh==3.10.5 triton==2.0.0 typer==0.7.0 typing_extensions==4.1.1 urllib3==1.26.9 urwid==2.1.2 urwid-readline==0.13
ip install GitPython==3.1.27 gdown

pip install uuid==1.30 wandb==0.12.11 wasabi==1.1.1 wcwidth==0.2.5 Werkzeug==2.0.3 yarl==1.7.2 yaspin==2.1.0 zipp==3.7.0
